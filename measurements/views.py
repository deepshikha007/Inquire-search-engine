...
def calculate_distance_view(request):
    ...
    # initial folium map
    m = folium.Map(width=500, height=300, location=get_center_coordinates(l_lat, l_lon), zoom_start=8)
    # location marker
    ...
    if form.is_valid():
        ...
        m = folium.Map(width=550, height=400, location=get_center_coordinates(l_lat, l_lon, d_lat, d_lon), zoom_start=get_zoom(distance))
        # location marker
